...
const SideBar = ({UserMenues,setUserTool,userTool}) => {
    return (
        <>
            <ul className='flex flex-col list-none gap-[6px] text-left'>
                {
                    UserMenues?.map((menu, indx) => {
                        return (
                            <li 
                                key={indx} 
                                className={`${userTool===menu.slug?"bg-[#4b5563] shadow-lg":""} xl:pl-8 md:pl-4 py-[16px] hover:bg-[#4b5563]  text-[#343434] hover:shadow-lg rounded-md group`}
                            >
                                <Link 
